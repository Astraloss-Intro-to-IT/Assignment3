const reviews = [
    ...
    },
    {
      ...
      img:
        "images/MinhDuc.jpg",
      text:
        "I was born in Hanoi and live in a nuclear family. I have great interest in interface designing, animating short cartoons and drawing doodles. I have had experience in UI/UX designing and debugging Python code. In the Myers-Briggs test, I am a Mediator, someone who will resolve issues within a team when they emerge. My function appears to be critical, since there should be someone to balance the workload and keep things running well. I can come up with a novel answer to some difficult and long-standing problems. In this approach, teammates can work out their differences and follow the leader's new directions. I did mention in the Individual Week 8 that I responsible for the project managing role that keep things running well and up to now, my teammates really believe on my role since I gave them good and efficient directions to work in different tasks: from interview to web layouts and the way to summarize information from a raw video/researching material. I also show my designing and drawing skills in the interview video for the preparation part. I am aiming for the UI/UX designers at AIMENEXT, a Japanese company. My field is quite different from other teammates since they focus on the career relating to apps and webs development,  except for Duc Nguyen, he aims for the Front-End development. Besides, we are all aiming for the RMIT graduation with a bachelor’s degree of IT field and gaining experience from projects and internships by the time to fulfill our career goals.",
    },
    {
      id: 4,
      name: "Nguyen The Duc",
